...
const PaymentStep: React.FC<PaymentStepProps> = ({ member }) => {
  const {
    register,
    formState: { errors },
    watch,
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Bank Transfer">🏛️</option>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
                ...
                <div className="md:col-span-2 flex items-center justify-center my-4">
                  <div className="flex items-center w-full">
                    ...
                    <div className="px-6 py-3 bg-white rounded-full border-2 border-gray-200 shadow-sm">
